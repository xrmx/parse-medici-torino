mapboxgl.accessToken =
    'pk.eyJ1IjoiYW1vc2dpdG8iLCJhIjoiY2tleGIxc3N2NG16YzJzcGN1M205dnM3OSJ9.BfdMz6HWg9BBkAOV-qNj0w';
var map = new mapboxgl.Map({
    container: 'map', // container id
    style: 'mapbox://styles/mapbox/streets-v11', // style URL
    center: [7.7, 45.06], // starting position [lng, lat]
...
map.on('load', async function () {
    ...
    filterEl.addEventListener('keyup', function (e) {
        ...
        var filtered = source.filter(function (feature) {
            ...
            return name.indexOf(value) > -1 || circ.indexOf(value) > -
                1 /*|| indirizzo.indexOf(value) > -1 || code.indexOf(value) || assoc.indexOf(value)*/ ; //nel caso servissero le altre tre variabili???
        });
